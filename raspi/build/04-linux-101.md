...
All computers (even the cute little Raspberry Pi) run an *operating system* which is composed of hundreds or thousands of separate pieces of computer code. Whenever you want to add new abilities to a computer, you have to install even more codes. It's important to keep your software up-to-date in order to get access to the latest features :star:, avoid security problems :imp:, and fix bugs :ant:

The kind folks who make Linux available publish lists of the latest versions of software on special websites, along with special computer instructions to install and update them. 

### Updating your software

Today, and once in a while it's good to refresh the list of available software, compare it to what's currently installed, and automatically update everything where possible. A common command-line tool for interacting with installed software is **apt-get**

* Please enter the following text into a Terminal window: `sudo apt-get update`

![Updates going on...](images/updates.jpg)

** You will see some text scroll by as the system accesses all the remote lists. **

* Now enter this command: `sudo apt-get -y upgrade`

### Finding and installing software

On occasion, you will need to install new software on the Raspberry Pi. A lot of the time, but not always, such software is available in the public Linux catalog, which means you can install it using **apt-get**
