...
The dollar sign is a prompt, which shows us that the terminal shell is waiting for input.input is general in the form of a text command often with some options that change how the command acts:
```
